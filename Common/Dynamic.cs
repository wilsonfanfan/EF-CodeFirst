...
namespace System.Linq.Dynamic
{
    ...
    public static class DynamicQueryable
    {
        ...
        /// <param name="values">The values.</param>
        /// <returns></returns>
        public static IQueryable<T> SortBy<T>(this IQueryable<T> source, string ordering, params object[] values)
        {
            return (IQueryable<T>)SortBy((IQueryable)source, ordering, values);
        }
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException"></exception>
        public static IQueryable SortBy(this IQueryable source, string ordering, params object[] values)
        {
            if (source == null) throw new ArgumentNullException("source");
    ...
    internal class ExpressionParser
    {
        ...
        void ProcessValues(object[] values)
        {
            for (int i = 0; i < values.Length; i++)
            {
                ...
                {
                    AddSymbol("@p" + i.ToString(System.Globalization.CultureInfo.InvariantCulture), value);
                }
            }
        }
